...
public class ArticleWebView extends SearchableWebView {
  ...
  public ArticleWebView(Context context) { this(context, null); }
  ...
  public ArticleWebView(Context context, AttributeSet attrs) {
    ...
    this.setWebViewClient(new WebViewClient() {
      ...
      public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        if (times.containsKey(url)) {
          ...
          try {
            ...
            Log.w(TAG,
                  "Failed to schedule applyStylePref in view " + view.getId(),
                  ex);
          }
        }
      }
      ...
      public void onPageFinished(WebView view, String url) {
        ...
        if (times.containsKey(url)) {
          ...
          Log.d(TAG, "onPageFinished: finished: " + url + " in " +
          ...
          Log.w(TAG,
                "onPageFinished: Unexpected page finished event for " + url);
        }
        view.loadUrl("javascript:" + styleSwitcherJs +
      ...
      public boolean shouldOverrideUrlLoading(WebView view, final String url) {
        ...
        if (scheme.equals("http") && host.equals(LOCALHOST) &&
          ...
          Intent intent =
              new Intent(getContext(), ArticleCollectionActivity.class);
          intent.setData(uri);
    ...
    this.setOnLongClickListener(new OnLongClickListener() {
      ...
      public boolean onLongClick(View view) {
        ...
        Log.d(TAG, String.format("Long tap on element %s (%s)", resultType,
  ...
  boolean allowRemoteContent() {
    ...
    String prefValue =
        prefs.getString(PREF_REMOTE_CONTENT, PREF_REMOTE_CONTENT_WIFI);
  ...
  private void setStyle(String styleTitle) {
    ...
    if (prefs.contains(styleTitle)) {
      ...
      js = String.format("javascript:" + Application.jsUserStyle, elementId,
                         css);
    } else {
      js = String.format("javascript:" + Application.jsClearUserStyle +
                             Application.jsSetCannedStyle,
  ...
  private String getCurrentSlobId() { return currentSlobId; }
  ...
  private void loadAvailableStylesPref() {
    if (currentSlobUri == null) {
      Log.w(TAG,
            "Can't load article view available styles pref - slob uri is null");
      return;
    }
    SharedPreferences prefs = prefs();
    Log.d(TAG, "Available styles before pref load: " + styleTitles.size());
    styleTitles = new TreeSet(prefs.getStringSet(
        PREF_STYLE_AVAILABLE + currentSlobUri, Collections.EMPTY_SET));
  ...
  private void updateBackgrounColor() {
    ...
    // extra flash
    //
    // TODO Hack it even more - allow style title to include background color
    // spec so that this can work with "strategically" named user css

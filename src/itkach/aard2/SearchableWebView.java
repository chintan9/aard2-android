...
class SearchableWebView extends WebView {
  ...
  public void setLastFind(String find) { mLastFind = find; }

  public SearchableWebView(Context context) { this(context, null); }
  ...
  public boolean showFindDialog(String text, boolean showIme) {
    FindActionModeCallback callback =
        new FindActionModeCallback(getContext(), this);
